...
# ==========================================
# 1. Configuration (የእርስዎ ቶከን እና የፎልደር አድራሻ)
# ==========================================
...
# CORS Config (ከGitHub Pages ጋር እንዲነጋገር)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
class BingoEngine:
    ...
    def check_regular_win(card: dict, drawn_balls: list) -> bool:
        """10 ብር ጨዋታ: 1 መስመር (አግድም/ቋሚ/ሰያፍ) ወይም 4ቱ መአዘኖች"""
    ...
    def check_superbingo_win(card: dict, drawn_balls: list) -> bool:
        """50 ብር SuperBingo: ሙሉ ዝግ (Full House)"""
        drawn = set(drawn_balls)
        drawn.add('FREE')
